...
public class ClientPageCRM extends CommonPageCRM {
    ...
    public By inputClientGroups = By
            .xpath("(//label[normalize-space()='Client groups']/following-sibling::div//input)[1]");
    ...
    public void verifyClientDetail(Hashtable<String, String> data) {
        ...
        WebUI.verifyElementTextEquals(ownerDetail, data.get(ClientModel.getOwner()),
                FailureHandling.CONTINUE_ON_FAILURE);
        WebUI.verifyElementTextEquals(inputAddress, data.get(ClientModel.getAddress()),
                FailureHandling.CONTINUE_ON_FAILURE);
        ...
        WebUI.verifyElementTextEquals(labelClientGroups, data.get(ClientModel.getClientGroup()),
                FailureHandling.CONTINUE_ON_FAILURE);
