...
public class AddProductPage extends CommonPageCMS {
        ...
        private By selectChooseGalleryImgs = By.xpath(
                        "//label[contains(text(),'Gallery Images')]/following-sibling::div//div[contains(text(),'Choose File')]");
        private By selectChooseThumbnailImgs = By.xpath(
                        "//label[contains(text(),'Thumbnail Image')]/following-sibling::div//div[contains(text(),'Choose File')]");
        ...
        private By selectUnitDiscount = By
                        .xpath("(//div[@class='filter-option-inner-inner'][normalize-space()='Flat'])[1]");
        ...
        private By selectChooseMetaImage = By.xpath(
                        "//label[normalize-space()='Meta Image']/following-sibling::div//div[contains(text(),'Choose File')]");
        ...
        public void addProduct(String productName, String category, String unit, String weight, String tags,
                        String unitPrice, String discountDate, String quantity, String description, String discount,
                        String imgName) {
                ...
                // WebUI.uploadFileWithLocalForm(buttonBrowseImages,
                // SystemHelpers.getCurrentDir() + "src" + File.separator + "test" +
                // File.separator + "resources" + File.separator + "testdataCMS" +
                // File.separator +
                // imgName);
                // Upload images Gallery with sendKeys
                DriverManager.getDriver().findElement(inputGalleryImages)
                                .sendKeys(SystemHelpers.getCurrentDir() + "src" + File.separator + "test"
                                                + File.separator + "resources" + File.separator + "testdataCMS"
                                                + File.separator
                                                + imgName);
        ...
        public void verifyNewProduct(String category, String unit, Double unitPrice, String description) {
                ...
                WebUI.sleep(2);
                WebUI.verifyEquals(
                                WebUI.getTextElement(By.xpath("//h1[normalize-space()='" + nameProductVerify + "']"))
                                                .trim(),
                                nameProductVerify, "Product name displayed wrong");
                WebUI.verifyEquals(WebUI.getTextElement(unitUI).trim(), "/" + unit, "Unit displayed wrong");
                WebUI.scrollToElementAtBottom(descriptionUI);
                WebUI.verifyEquals(WebUI.getTextElement(descriptionUI).trim(), description,
                                "Description displayed wrong");
                WebUI.sleep(2);
                ...
                WebUI.waitForPageLoaded();
                WebUI.sleep(2);
                WebUI.verifyElementVisible(By.xpath("(//a[normalize-space()='" + nameProductVerify + "'])"),
                                "Product is NOT displayed in Category");
        }
}
