...
/**
 * FrameworkConstants là nơi tập trung đọc và lưu trữ toàn bộ các hằng số (constants)
 * từ các file cấu hình (như config.properties, data.properties) vào bộ nhớ RAM một lần duy nhất.
 * Nhờ có static block, khi hệ thống khởi động, nó sẽ nạp tất cả biến này để dùng chung cho mọi file.
 */
