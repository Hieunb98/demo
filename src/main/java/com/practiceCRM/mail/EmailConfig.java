...
package com.practiceCRM.mail;

import static com.practiceCRM.constants.FrameworkConstants.REPORT_TITLE;
...
public class EmailConfig {
    ...
    public static final String FROM = "hieu.nguyenbat.neu@email.com";
    public static final String PASSWORD = "******";

    public static final String[] TO = {"@mailinator.com"};
