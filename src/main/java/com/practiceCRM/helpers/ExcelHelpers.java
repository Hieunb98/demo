...
import com.practiceCRM.exceptions.InvalidPathForExcelException;
...
/**
 * ExcelHelpers là tiện ích để đọc và ghi dữ liệu từ file Excel (.xlsx).
 * Sử dụng thư viện Apache POI.
 * Thường được gọi bởi DataProviderManager để truyền dữ liệu (Data-Driven) vào
 * TestNG.
 */
public class ExcelHelpers {
    ...
    public void setCellData(String text, int rowNumber, int colNumber) {
        try {
            ...
            // Fix bug: So sánh String trong Java phải dùng .equals() thay vì ==
