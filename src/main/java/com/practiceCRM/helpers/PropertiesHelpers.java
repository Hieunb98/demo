...
import com.practiceCRM.utils.LanguageUtils;
...
/**
 * PropertiesHelpers là công cụ hỗ trợ đọc và ghi dữ liệu từ các file cấu hình
 * (.properties).
 * Class này sử dụng đối tượng java.util.Properties của Java để lưu trữ
 * key-value.
 */
public class PropertiesHelpers {
    ...
    public static Properties loadAllFiles() {
        ...
        // Add tất cả đường dẫn các file Properties vào danh sách
        ...
        try {
            ...
            for (String f : files) {
                ...
                tempProp.load(file);
                // Gộp toàn bộ key-value từ file hiện tại vào biến properties chung
    ...
    /**
     * Lấy giá trị của một biến (key) từ file cấu hình.
     * Hàm này được dùng rất nhiều trong FrameworkConstants.
     * 
     * @param key Tên biến cấu hình (ví dụ: "BROWSER")
